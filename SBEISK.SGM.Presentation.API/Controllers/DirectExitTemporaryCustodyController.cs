...
namespace SBEISK.SGM.Presentation.API.Controllers
{
    ...
    public class DirectExitTemporaryCustodyController : BaseController
    {
        ...
        public DirectExitTemporaryCustodyController(IDirectExitReceiverRepository directExitReceiverRepository, IReceivementEmailRepository emailRepository,
        ...
        ///</remarks>
        [HttpPost]
        public IActionResult Post([FromForm] DirectExitReceiverRequest request)
        {
            if(ModelState.IsValid)
            {
                if(request != default(DirectExitReceiverRequest))
                {
                    ...
                    {
                        exitReceiver.DirectExitReceiverMaterials = this.exitMaterialRepository.AddExitTemporaryCustodyMaterial(request.MaterialCodesAmounts).ToList();
                    }
